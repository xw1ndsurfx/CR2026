...
public partial class GameInterface
{
    ...
    private void UpdatePoker()
    {
        ...
        {
            _pokerWindow?.Destroy(); _pokerWindow = null; return;
        }
    ...
    private bool ClosePokerWindow()
    {
        ...
        SendPokerRequest(PokerRequestKind.Leave, 0); _pokerModel.Dismiss();
        _pokerWindow?.Destroy(); _pokerWindow = null; return true;
    }
    private void DisposePoker()
    {
        DisposeBlackjack();
        lock (_pokerInboxLock) { _pokerDisposed = true; _pokerInbox.Clear(); }
        _pokerModel.Dismiss(); _pokerWindow?.Destroy(); _pokerWindow = null;
    }
}
